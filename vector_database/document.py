...
def upsert_document(
    index_name: str, namespace: str, document: List[Union[dict, Document]]
):
    """
    Upsert a document into a Pinecone index.
    This will use the ingestion pipeline to split the document
    ...
    pipeline = get_pipeline(
        PineconeVectorStore(pinecone_index=index, namespace=namespace)
    )
